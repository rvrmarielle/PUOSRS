    ...
    <p class="text-dark font-weight-bold text-uppercase small px-2 p-3 bg-white">HANDOG KAIBIGAN SCHOLARS</p>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="scholars_csdl.php">Previous Scholars</a>
                </li>
                <li class="nav-item">
            ...
            <div class="card-body">
            <a type="button" class="btn btn-outline-danger btn-sm float-right mb-3" data-toggle="modal" data-placement="top" title="delete all" data-target="#deleteall" style="font-size:12px;">Delete all data</a>
            ...
            <?php
                        $query = "SELECT * FROM `listofmembers` ORDER BY `listofmembers`.`id` DESC";
                        $result = mysqli_query($db_link, $query);
                        $count = 1;
                        while ($row = mysqli_fetch_array($result)) {
                        ?>
                        <tr style="font-size:13px">
                            ...
                            <td>
                                  ...
                                  <a href="" class="badge badge-warning p-2" data-toggle="modal" data-placement="top" title="edit" data-target="#editscholars<?php echo $row['id']; ?>"><span><i class="fa fa-pencil" aria-hidden="true" style="width:10px; color:white;"></i></span></a>
                                  <a href="" class="badge badge-danger p-2" data-toggle="modal" data-placement="top" title="remove" data-target="#remove<?php echo $row['id']; ?>"><span><i class="fa fa-trash" aria-hidden="true" style="width:10px;"></i></span></a>
                                  <a href="" class="badge badge-secondary p-2" data-toggle="modal" data-placement="top" title="remove" data-target="#remove<?php echo $row['id']; ?>">deactivate</a>
                                  
                              </td>
                              <td></td>
                        </tr>
                        <!-- modal remove -->
                        <div class="modal fade" id="remove<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a type="button" class="btn btn-danger btn-sm" href="functions.php?remove=<?php echo $row["id"] ?>">Confirm</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="modal fade" id="deleteall" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">Cancel</button>
                                            <a type="button" class="btn btn-danger btn-sm" href="functions.php?deleteall">Confirm</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- modal edit -->
                            <div class="modal fade" id="editscholars<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">Cancel</button>
                                            <button type="submit" name="editScholars" class="btn btn-success btn-sm">Save Changes</button>
                                        </div>
                                        </form>
                                    </div>
                                </div>
